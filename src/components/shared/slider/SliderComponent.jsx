            ...
            <div className="container">
              <div className="onboard-content">
                ...
                <p className="onboard-content__txt">
                  Start by telling us about your task. Mention when and where
                  (in person or remotely) you need it done, then suggest a fair
                  budget for the task. Post any task, literally!
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="container">
              <div className="onboard-content">
                ...
                <p className="onboard-content__txt">
                  Take a look at profiles and reviews to pick the best Tasker
                  for your task. when you accept an offer, your payment is held
            ...
            <div className="container">
              <div className="onboard-content">
                ...
                <p className="onboard-content__txt">
                  ...
                  the Tasker so everyone can know what a great job they’ve
                  done!.
                </p>
              </div>
            </div>
